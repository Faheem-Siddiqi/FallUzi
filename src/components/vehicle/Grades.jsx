  ...
  return (
    <>
      <div className='rounded-xl   bg-white p-5 my-5'>
        <h2 className='text-3xl text-black font-semibold'>Grades</h2>
        <div className='flex items-center  justify-center  flex-col xl:flex-row gap-4 my-5'>
          ...
          <div className='flex flex-col w-full xl:w-[75%]'>
            ...
            <p className='text-sideText'>Familarity: I owned this Car</p>
            <div className='flex' >
            </div>
          </div>
        </div>
        ...
        <div className='flex flex-wrap gap-5 my-5 xl:justify-start justify-between'>
          ...
          {/*  */}
          <div className='w-full  xl:w-fit flex items-center gap-5'>
            <p className='font-bold text-black'>Tire Grade</p>
            <div className="flex">
              <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 0L8.65258 4.96591H14L9.674 8.03409L11.326 13L7 9.93012L2.67342 12.9994L4.326 8.03352L0 4.96591H5.34742L7 0Z" fill="#EF730F" />
              </svg>
        ...
        {/*  */}
        <div className='w-full  xl:w-fit flex items-center gap-5'>
            <p className='font-bold text-black'>Mechanical Grade</p>
            <div className="flex">
              <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 0L8.65258 4.96591H14L9.674 8.03409L11.326 13L7 9.93012L2.67342 12.9994L4.326 8.03352L0 4.96591H5.34742L7 0Z" fill="#EF730F" />
              </svg>
